...
const SignInForm = () => {
    return (
        ...
        <div className="mb-8">
        <h2 className="text-5xl text-center text-black font-polySans leading-15 mb-4">Sign in to your account.</h2>
        <p className="text-black text-center font-polySans mb-4">
            Build skills for today, tomorrow, and beyond. <br></br>Education to future-proof your career.
        </p>
        </div>
        
        <div className="flex justify-around font-polySans  mb-4 items-center">
      ...
      <div className="mb-4 font-polySans">
        ...
        <div>
        <a href="#" className="block py-4 text-blue-900 font-medium mb-2 text-center">Forgot your password?</a>
        ...
        <a href="#" className="block py-6 text-blue-900 font-medium mb-2 text-center">Sign in with your organization.</a>
        </div>
